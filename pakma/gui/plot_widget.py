...
class RealTimePlotWidget(QWidget):
    ...
    def __init__(self, title: str = "Real-Time Physics Graph", parent=None):
        ...
        pg.setConfigOptions(antialias=True, background='#141418', foreground='#d0d0d8')
        ...
        self.curve_colors = [
            '#00d2ff', '#ff007f', '#00ff88', '#ffaa00', '#bb86fc', '#03dac6', '#ff5252'
        ]
        ...
        self.coord_label.setStyleSheet("color: #00d2ff; font-weight: bold;")
        ...
        # Crosshair lines
        self.v_line = pg.InfiniteLine(angle=90, movable=False, pen=pg.mkPen('#ffaa00', width=1, style=Qt.PenStyle.DashLine))
        self.h_line = pg.InfiniteLine(angle=0, movable=False, pen=pg.mkPen('#ffaa00', width=1, style=Qt.PenStyle.DashLine))
