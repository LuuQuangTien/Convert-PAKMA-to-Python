...
class SerialPortDialog(QDialog):
    ...
    def __init__(self, serial_mgr: SerialManager, parent=None):
        ...
        self.txt_terminal.setStyleSheet("background-color: #ffffff; color: #107c41; font-family: 'Consolas', monospace;")
    ...
    def send_data(self):
        ...
        if text:
            ...
            self.txt_terminal.append(f"<span style='color: #0078d7;'>&gt; {text}</span>")
            self.txt_send.clear()
    ...
    def _on_conn_status(self, connected: bool, msg: str):
        self._update_ui_state()
        color = "#107c41" if connected else "#d83b01"
    ...
    def _update_ui_state(self):
        if self.serial_mgr.is_connected:
            ...
            self.btn_toggle_connect.setStyleSheet("background-color: #0078d7; color: white;")
